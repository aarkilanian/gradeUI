...
Comparing The Two Graphs: 
  Since Balsam fir have much higher bars than Black Spruce, moose browse Balsam Fir more often.
...
Sampling Bias Comments
The dataset cannot be evenly distributed when some species or regions have greatly higher counts.
Acknowledging bias remains incredibly important, uneven sampling may lead to wrong conclusions revolving moose browsing.
...
ggplot(sum_spe_browse,
       aes(x = AvgDensity, y = AvgBrowsing, color = Species)) +
  geom_point(size = 3) +
  theme_minimal() +
...
Moose seem to enjoy Willow the most, while other species with lowers scores are preferred less.
...
Regions with higher moose density generaally have more collisions, even though some may show as outliers.
...
Regions with smaller human pops. may show a higher per capita collision rates.
This is logical because rural communities have less people, and more room for moose.
