# Name: Allison Osmond
# Student Number: 202511350
# Course: BIOL1002
# Assignment: Moose Populations & Browsing

# Set working directory
# setwd("User/AllisonOsmond/Documents/RStudio")
...
# Answer:
# Oldest year in dataset is: year_min
# Highest estimated moose population is: moose_max
...
# Answer:
# The ecoregion with the highest average browsing is the first row.
# The ecoregion with the lowest average browsing is the last row.
...
# Answer:
# Species with highest browsing is the first row.
# Species with lowest browsing is the last row.
...
# Question 20:
# a) The SaplingStudy dataset is not evenly distributed. Some ecoregions and species are sampled more heavily.
...
# Balsam Fir appears to be most favoured, while Black Spruce is browsed least.
