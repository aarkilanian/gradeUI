#Part 1 - Moose Populations in Newfoundland and Labrador
...
#According to the above code, the maximum moose population was 41250.
...
barplot(fir_reg_browse$BrowsingScore, names.arg = fir_reg_browse$Ecoregion, 
        ...
        col = "blue", 
        cex.names = 0.3)   
#I had to make cex.names smaller than the 0.6 recommended to fit the labels.
...
sap_reg_tally<- sap_clean %>%
  ...
  tally() %>% 
  print()
#"n" in this table show s that a different amount of trees were counted in
#each Ecoregion.
...
#each species.
#This sapling study is not evenly distributed because of sampling bias. There 
...
sum_spe_browse <- moose_sap %>%
  ...
  print()
#According to the figure plot in Question 23:
...
#(b) The most-browsed and therefore preferred species is the Willow, and the 
