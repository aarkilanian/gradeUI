library(dplyr)
library(dplyr)
MoosePopulation_2_ <- read.csv("C:/Users/Madison Slaney/Downloads/MoosePopulation (2).csv")
# Madison Slaney R assignment.

#1.)library(readr)

#2.)MoosePopulation_2_ <- read.csv("C:/Users/Madison Slaney/Downloads/MoosePopulation (2).csv") 

#3.)moose_clean <- na.omit(MoosePopulation_2_)
